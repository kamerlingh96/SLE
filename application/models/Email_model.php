...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '', $password = '')
	{
		...
		$email_msg		.=	"Su tipo de cuenta : ".$account_type."<br />";
		$email_msg		.=	"Su contraseña de inicio de sesión : ". $password ."<br />";
		$email_msg		.=	"Entre aquí : ".base_url()."<br />";

		$email_sub		=	"Correo electrónico de apertura de cuenta";
		$email_to		=	$email;
	...
	function password_reset_email($new_password = '' , $account_type = '' , $email = '')
	{
		...
		if($query->num_rows() > 0)
		{
			...
			$email_msg	.=	"Tu contraseña es : ".$new_password."<br />";
	...
	function contact_message_email($email_from, $email_to, $email_message) {
		$email_sub = "Mensaje del sitio web de la escuela";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$config = array();
        $config['useragent']	= "ARTBOT Róbotica";
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://www.artbot.com.mx\">&copy; 2018 ARTBOT Róbotica, Sistema de Gestión Escolar Profesional</a></center>";
