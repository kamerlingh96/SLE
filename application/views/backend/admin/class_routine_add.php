...
<div class="row">
	<div class="col-md-12">
		...
		<?php echo form_open(site_url('admin/class_routine/create') , array('class' => 'form-horizontal form-groups validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
            ...
            <div id="section_subject_selection_holder"></div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">PDF Horario</label>
							<input type="file" name="file_name" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Examinar" />
						</div>
