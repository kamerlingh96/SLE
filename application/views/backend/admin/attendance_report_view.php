...
<?php if ($class_id != '' && $section_id != '' && $month != '' && $sessional_year != ''): ?>
    ...
    for ($i = 1; $i <= $days; $i++) {
                        ...
                        <tr>
                            ...
                            for ($i = 1; $i <= $days; $i++) {
                                ...
                                foreach ($attendance as $row1):
                                    ...
                                    $demeritoTotal= $demeritoTotal+$demerito;
                                ...
                                <td style="text-align: center;">
            <?php if ($status == 1) { ?>
                                        <i class="entypo-record" style="color: #00a651;"></i>/<?=$recompensa?>/<?=$demerito?>
                            <?php  } if($status == 2)  { ?>
                                        <i class="entypo-record" style="color: #ee4749;"></i>/<?=$recompensa?>/<?=$demerito?>
            <?php  } $status =0;?>
        ...
        <?php } ?>
        <td><?php if($recompensaTotal>0){echo $recompensaTotal;}else{echo "0";}?></td>   <!--            total      -->
        <td><?php if($demeritoTotal>0){echo $demeritoTotal;}else{echo "0";}?></td>   <!--            total      -->
    <?php endforeach; ?>
