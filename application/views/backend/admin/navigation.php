<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_attendance' ||
            ...
            <ul>
                    <!-- COMPRA -->
                    <li class="<?php if ($page_name == 'compra' || $page_name == 'compra') echo 'opened active'; ?> ">
                        <a href="#">
                            <span><i class="entypo-dot"></i> <?php echo "Compra"; ?></span>
                        </a>
                        <ul>
                            <?php
                            $classes = $this->db->get('class')->result_array();
                            foreach ($classes as $row):
                                ?>
                                <li class="<?php if ($page_name == 'manage_purchase' && $class_id == $row['class_id']  && $class_id == $row['class_id']) echo 'active'; ?>">
                                <!--<li class="<?php if ($page_name == 'manage_purchase'  && $class_id == $row['class_id']) echo 'active'; ?>">-->
                                    <a href="<?php echo site_url('admin/compra/' . $row['class_id']); ?>">
                                        <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                                    </a>
                                </li>
                            <?php endforeach; ?>
        ...
        <li class="<?php if ($page_name == 'frase' || $page_name == 'frase') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/frase'); ?>">
              <i class="entypo-doc-text-inv"></i>
                <span><?php echo get_phrase('Frase'); ?></span>
            </a>
        </li>
