                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="day" class="form-control selectboxit">
                            ...
                            <option value="miercoles" 		<?php if($row['day']=='miercoles')echo 'selected="selected"';?>>Miércoles</option>
                            ...
                            <option value="sabado" 	<?php if($row['day']=='sabado')echo 'selected="selected"';?>>Sábado</option>
