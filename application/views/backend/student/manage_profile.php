                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="sex" class="form-control selectboxit">
                                      ...
                                      <option value="masculino" <?php if($row['sex'] == 'male')echo 'selected';?>><?php echo get_phrase('male');?></option>
                                      <option value="femenino"<?php if($row['sex'] == 'female')echo 'selected';?>><?php echo get_phrase('female');?></option>
                                  </select>
                                </div> 
                            </div>
