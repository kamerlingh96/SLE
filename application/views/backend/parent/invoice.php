                ...
                <div class="row">
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(site_url('parents/paypal_checkout/'. $row['student_id']));?>
                    	<input type="hidden" name="invoice_id" value="<?php echo $row2['invoice_id'];?>" />
                    		<button type="submit" class="btn btn-info" <?php if($row2['due'] == 0 || $paypal_activity == 0):?> disabled="disabled"<?php endif;?>>
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(site_url('parents/stripe_checkout/'.$row['student_id']));?>
                    	<input type="hidden" name="invoice_id" value="<?php echo $row2['invoice_id'];?>" />
                    		<button type="submit" class="btn btn-default" <?php if($row2['due'] == 0 || $stripe_activity == 0):?> disabled="disabled"<?php endif;?>>
